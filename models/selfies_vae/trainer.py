...
import os
from utils.draw_utils import molecule_to_pdf
...
class VAETrainer(Trainer):
    ...
    def load_train_data(self):
        with open("/home/khangnn4/latent_based/data/train.txt", "r") as file_:
            data = file_.readlines()[1:]
        return data

    def load_val_data(self):
        with open("/home/khangnn4/latent_based/data/val.txt", "r") as file_:
            data = file_.readlines()[1:]
        return data
    ...
    def _train(self, model, train_loader, val_loader=None, logger=None):
        ...
        for epoch in range(n_epoch):
            ...
            for idx, smi in enumerate(s):
                try:
                    smi = inverter(smi)
                    mol = Chem.MolFromSmiles(smi)
                    molecule_to_pdf(mol, f"ligands/mol_{idx}.pdf")
                except:
                    continue
